    ...
    <MainLayout user={layoutUser}>
      ...
      <div className="bg-white border-b border-primary-100 shadow-sm mb-6">
        <div className="px-6 py-4 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-primary-600">Checklist Management</h1>
            <p className="text-gray-600 text-sm mt-1">Create, update, and manage checklist templates and items</p>
          </div>
          <button
            onClick={() => {
              setTemplateForm({ name: '', version: '', description: '', deptId: null, status: 'Active', isActive: true });
      ...
      <div className="px-6 pb-6 space-y-6">
        ...
        {showCreateForm && (
          <form onSubmit={handleCreateTemplate} className="bg-white rounded-xl border border-primary-100 shadow-md p-6">
            <h2 className="text-lg font-semibold text-primary-600 mb-4">Create New Checklist Template</h2>
        ...
        {/* Edit Template Form */}
        {editOpen && (
          <form onSubmit={handleUpdateTemplate} className="bg-white rounded-xl border border-primary-100 shadow-md p-6">
            <h2 className="text-lg font-semibold text-primary-600 mb-4">Edit Checklist Template</h2>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {paginatedTemplates.map((template, idx) => {
                      ...
                      return (
                        <tr key={template.templateId || template.$id || idx} className="hover:bg-gray-50 transition-colors">
      ...
      {showItemsModal && selectedTemplate && createPortal(
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
          ...
          />
          <div className="relative bg-white rounded-xl shadow-xl w-full max-w-4xl mx-auto max-h-[90vh] overflow-y-auto">
            <div className="p-6">
