...
const DepartmentChecklist = () => {
                          ...
                          <div className="flex items-center justify-end sm:justify-start gap-2 sm:gap-3 flex-shrink-0">
                            {isCompliant(item.status) ? (
                              ...
                              <div className="flex items-center gap-2">
                                <div className=" sm:px-4  sm:py-2  rounded-full text-[10px] sm:text-xs font-bold whitespace-nowrap border shadow-sm flex items-center gap-1.5">
 ...
 className={`w-6 h-6 flex items-center justify-center rounded-full 
  bg-blue-100 hover:bg-blue-200 text-blue-600 transition-colors active:scale-95 
  ${loadingCompliantId ? 'opacity-50 cursor-not-allowed' : ''}`}  >
                                  {loadingCompliantId ? (
                              ...
                              <button
                               className="w-6 h-6 flex items-center justify-center rounded-full 
  bg-blue-100 hover:bg-blue-200 text-blue-600 active:scale-95"  onClick={(e) => {
                                  e.stopPropagation();
                                  handleViewFinding(item);
                                }}
                                title="View Finding Details"
                              >
                                <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                  </svg>
  ...
  hover:bg-red-600 text-white border-2 border-red-600 shadow-md hover:shadow-lg 
  active:scale-95" onClick={(e) => {
                                    e.stopPropagation();
