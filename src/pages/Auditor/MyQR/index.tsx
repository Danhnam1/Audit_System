                    ...
                    >
                      ...
                      <div className="space-y-3">
                        ...
                        {grant.verifyCode && (
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <p className="text-sm font-mono text-gray-900">{grant.verifyCode}</p>
                              <button
                                onClick={() => copyToClipboard(grant.verifyCode!)}
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            <p className="text-xs text-gray-600 truncate flex-1">{grant.qrUrl}</p>
                            <button
                              onClick={() => copyToClipboard(grant.qrUrl)}
                              className="text-primary-600 hover:text-primary-700 text-xs flex-shrink-0"
                              title="Copy URL"
                            >
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
