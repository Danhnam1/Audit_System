    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-primary-100 shadow-md p-6">
          <h2 className="text-lg font-semibold text-primary-600 mb-4">Quick Access</h2>
          <p className="text-sm text-gray-600 mb-4">Use the sidebar menu to navigate to different sections</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-primary-50 to-primary-100 rounded-lg p-4 border border-primary-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-semibold text-gray-800">Review Audit Plans</h3>
              </div>
              <p className="text-xs text-gray-600">Approve or reject audit plans forwarded by Lead Auditor</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 border border-green-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-semibold text-gray-800">Review Audit Results</h3>
              </div>
              <p className="text-xs text-gray-600">Review findings and corrective actions</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-4 border border-purple-200">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="text-base font-semibold text-gray-800">Summary Report</h3>
              </div>
              <p className="text-xs text-gray-600">View compliance rates and risk assessments</p>
            </div>
          </div>
        </div>
