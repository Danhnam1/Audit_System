...
const SQAStaffAuditPlanning = () => {
  ...
  const existingPlans = [
    { 
      ...
      version: 'v2.0',
      auditLead: 'Sarah Johnson (SQA Head)',
            ...
            <div className="space-y-4">
              ...
              {currentStep === 4 && (
                <div>
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Audit Lead (SQA Head)</label>
                      <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        <option>Select user </option>
                        <option>Sarah Johnson (SQA Head)</option>
                        <option>Mike Chen (SQA Head)</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Auditors (SQA Staff)</label>
                      <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
                        <option>Multi-select </option>
                        <option>John Smith (SQA Staff)</option>
                        <option>David Martinez (SQA Staff)</option>
                        <option>Emily Davis (SQA Staff)</option>
                      </select>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">Department Owner(s)</label>
                      <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500">
